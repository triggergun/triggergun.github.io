...
![IO流继承关系图](day14-IO.assets/IO流继承关系图.png)
...
- IO流介绍
  ...
  - 流：是一种抽象概念,是对`数据传输的总称`.也就是说数据在设备间的传输称为流,流的本质是数据传输
...
- 使用字节输出流写数据的步骤
  ...
  - 创建字节输出流对象(调用`系统功能`创建了文件,创建字节输出流对象,让字节输出流对象指向文件)
  - 调用字节输出流对象的写数据方法
