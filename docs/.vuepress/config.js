...
// rfcDoc
const rfcDocSidebarArray = require('./contents/sidebar/rfcDoc.js');
...
module.exports = {
    ...
    themeConfig: {
        ...
        sidebar: {
            ...
            //  谈数据库  ================================  end  ==========
            //  rfc_doc   ================================  start  ==========
            '/rfc_doc/': rfcDocSidebarArray,
            //  rfc_doc  ================================  end  ==========

            //  esp8266 start
            '/embedded/esp8266/': [
                {
                    title: 'esp8266-esp12E',
                    collapsable: false,
                    children: [
                        encodeURI('/embedded/esp8266/demo01_2025_12_12_01'),
                        encodeURI('/embedded/esp8266/demo01_2025_12_12_02'),
                    ]
                }
            ],
            //  esp8266 end
