...

      {
        ...
        items: [
          ...
          // 子选项 db top导航栏
          {
            text: 'db',
            items: [
              { text: "mysql实验总结", link: encodeURI('/lyp/db/mysql/mysql数据库总结/01添加唯一索引程序在添加数据') },
        ...
        items: [
          {
            text: '数学之美',
            items: [
              { text: "中等数学思想", link: encodeURI('/基础科学/数学基础/02中等数学思想/球体体积公式推过程') },
            ],
          }
        ]
      }
      ...
      '/基础科学/数学基础/': [
        {
          ...
          collapsable: false,
          children: [
            '/基础科学/数学基础/02中等数学思想/球体体积公式推过程',
            '/基础科学/数学基础/02中等数学思想/微积分的启蒙',
            '/基础科学/数学基础/02中等数学思想/02什么是微积分',
