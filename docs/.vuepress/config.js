    ...
    sidebar: {
      ...
      '/lyp/刷脸项目/': [
        ...
        //   4阶段
        {
          ...
          collapsable: false,
          children: [
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/01申请微信开发者账号4-1'),
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/02创建小程序项目4-2'),
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/03初始uni-app4-3'),
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/04创建登陆页面4-4'),
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/05创建注册页面4-5'),
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/06注册新用户的业务要点说明4-6'),
            encodeURI('/lyp/刷脸项目/04阶段-利用UNI-APP创建移动端项目(独木不成林，为后端项目匹配移动端项目)/07获取临时授权和微信基本信息4-7')
          ]
